package com.javatar.osrs.definitions.graphics;
...
public class Graphics3D extends Rasterizer2D {
    ...
    public boolean rasterClipEnable;
    public boolean field1909;
    public boolean lowMem;
    public boolean rasterGouraudLowRes = true;
    public int rasterAlpha;
    public int Rasterizer3D_zoom = 512;
    public int centerX;
    public int centerY;
    public int rasterClipX;
    public int Rasterizer3D_clipHeight;
    public int Rasterizer3D_clipNegativeMidX;
    public int Rasterizer3D_clipMidX2;
    public int Rasterizer3D_clipNegativeMidY;
    public int Rasterizer3D_clipMidY2;
    public int[] rasterClipY = new int[1024];
    ...
    public final void rasterGouraud(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
        int var9 = var4 - var3;
        int var10 = var1 - var0;
        int var11 = var5 - var3;
        int var12 = var2 - var0;
    ...
    public final void rasterTextureAffine(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14, int var15, int var16, int var17, int var18) {
